    ...
    <view class="header" :style="{ paddingTop: statusBarHeight + 'px' }">
      <view class="header-content">
        ...
        <view class="header-title">
          <text class="title-main">编辑房产记录</text>
          <text class="title-sub">修改房产相关信息</text>
        </view>
        ...
        <view class="form-section animate-slide-up">
          <view class="section-header">
            ...
            <view class="section-info">
              ...
              <text class="section-subtitle">Property Basic Info</text>
            </view>
          </view>
          ...
          <view class="form-item">
            ...
            <text v-if="errors.propertyType" class="error-text">{{ errors.propertyType }}</text>
          </view>
          ...
          <view class="form-row">
            <view class="form-item half">
              ...
              <view class="input-wrapper">
                <uni-icons type="measure" size="20" color="#999" class="input-icon"></uni-icons>
                <input
                  class="input"
                  type="number"
                  placeholder="请输入建筑面积"
                  ...
                  step="0.01"
                />
                <text class="unit" style="margin-left: 10rpx; color: #666; font-weight: bold;">㎡</text>
              </view>
            ...
            <view class="form-item half">
              ...
              <view class="input-wrapper">
                ...
                <input
                  ...
                  step="0.01"
                />
                <text class="unit" style="margin-left: 10rpx; color: #666; font-weight: bold;">万元</text>
              </view>
          ...
          <view class="form-item">
            ...
            >
              <view class="picker-wrapper">
                ...
                <text class="picker-text">{{ form.acquisitionDate || 'YYYY-MM-DD' }}</text>
              </view>
            </picker>
...
export default {
  ...
  methods: {
        ...
        .then(res => {
          if (res.code === 200 && res.data) {
            this.form = {
              ...
              propertyType: res.data.propertyType || 'HOUSE',
              address: res.data.address || '',
              area: res.data.area || '0',
              value: res.data.value || '',
              acquisitionDate: res.data.acquisitionDate || '',
              propertyCertificate: res.data.propertyCertificate || '',
              usageType: res.data.usageType || '自住',
    ...
    handleSave() {
      ...
      // 调用更新房产记录API
      put('/property/update', submitData)
        .then(res => {
          if (res.code === 200) {
            uni.showToast({
              title: '更新成功',
